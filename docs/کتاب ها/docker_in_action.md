...
ا**ARG چیه؟**  
پارامتریه که فقط در زمان _ساخت ایمیج_ (دوران `docker build`) قابل استفاده است و بعد از ساخت ایمیج، دیگر در دسترس نیست. ولی ENV هم زمان build و هم در زمان Run در دسترسه
